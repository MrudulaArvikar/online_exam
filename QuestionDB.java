...
n=10;
 ...
 q[3]=new Question("Instance variable is a variable \ndeclared in ___.","class and method","class","method","main()","b");
 q[4]=new Question("System.out.println(\"Hello\"); Here, out is of _ class.","PrintStream","String","System","PrintWriter","a");
